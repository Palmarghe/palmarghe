...
- [x] Supabase production migration `202609160001`–`009` ve atomik içerik/ilişki RPC migration `202609170010` uygulandı; RPC canlı Studio taslağında ve yerel rollback testinde doğrulandı.
