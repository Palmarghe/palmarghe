...
Sağdaki ayarlar günlük kullanım diline çevrilmiştir: **Kapak resmi** yazının liste ve vitrin görselidir; **Google başlığı/açıklaması** arama sonucunu anlatır; **Google ve site aramasında göster** kapalıysa içerik indekslenmez; **Paylaşım resmi** sosyal ağ önizlemesidir. **Yayın tarihi ve saati** yalnız **Zamanla** eyleminde ileri bir UTC zamanı ister. İlk yayında önce başlık, kısa açıklama, kategori ve kapak resmini tamamlayın; ardından içerik bloklarını yazıp **Yayınla** düğmesini kullanın.
